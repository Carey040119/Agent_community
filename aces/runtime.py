...
class LLMAgentRuntime(AgentRuntime):
    ...
    def _build_prompt(self, obs: AgentObservation, max_actions: int) -> str:
        ...
        lines.append(
            ...
            '{"action": "grant_access", "requester_id": "...", "resource": "...", "ttl_days": "(optional N)"}, '
            '{"action": "deny_access", "requester_id": "...", "resource": "...", "reason": "..."}, '
            '{"action": "revoke_access", "holder_id": "...", "resource": "..."}, '
            ...
            '{"action": "browse_skills", "query": "..."}, '
            '{"action": "adopt_skill", "skill_id": "..."}, '
            '{"action": "republish_skill", "skill_id": "(a skill you have adopted)"}, '
